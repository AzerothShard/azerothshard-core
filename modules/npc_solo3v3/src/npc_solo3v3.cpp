...
public:
	...
	bool OnGossipHello(Player* player, Creature* me)
	{
		...
		if (sConfigMgr->GetBoolDefault("Solo.3v3.FilterTalents", true))
		{
			infoQueue << "\n\n";
	...
	bool OnGossipSelect(Player* player, Creature* me, uint32 /*uiSender*/, uint32 uiAction)
	{
		...
		case 2: // 3v3 Join Queue Arena (rated)
		{
			...
			if (player->HasAura(26013) &&
				(sConfigMgr->GetBoolDefault("Solo.3v3.CastDeserterOnAfk", true) || sConfigMgr->GetBoolDefault("Solo.3v3.CastDeserterOnLeave", true)))
			{
				WorldPacket data;
