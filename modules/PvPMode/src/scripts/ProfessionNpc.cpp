...
class Professions_NPC : public CreatureScript
{
        public:
                ...
                bool OnGossipHello(Player *pPlayer, Creature* _creature)
                {
                        ...
                        pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Welcome to AzerothShard profession NPC", GOSSIP_SENDER_MAIN, 0);
                        pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_TRAINER, "[Professions] ->", GOSSIP_SENDER_MAIN, 196);
